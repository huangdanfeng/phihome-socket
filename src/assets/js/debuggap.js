/**
 * Created by patty on 2017/10/23.
 */
/*
 * 	author: vic wang
 */
    ...
    dg.init = {
        ...
        addStyle: function() {
            ...
            s.innerHTML = '' +
                ...
                '#debuggapRoot .dg-out{background-color: transparent;position: fixed;z-index: 999;bottom: 100px;left: 20px;border: 2px solid #00abe3;border-radius: 40px;width: 60px;height: 60px;box-sizing: content-box;}' +
                '#debuggapRoot .dg-inner{width:35px;height: 35px;background: #ccc;margin: 12px;border-radius: 20px;background-color: #00abe3;}' +
                ...
                '#debuggapBlock {}' +
                '#debuggapBlock .dg-leaf{width:90px;height:90px;border-radius:30px;text-align:center;line-height:90px;color:#fff;margin:1px;float:left;background-color:rgba(0,171,227,0.7);}' +
                '#debuggapBlock .dg-flower{width:188px;height:188px;position:fixed;z-index:999;left:50%;top:50%;margin-left:-72px;margin-top:-72px;opacity:0;display:none;-webkit-transition:opacity 0.5s;}' +
                '#debuggapBlock .dg-center{width:74px;height:74px;position:absolute;left:55px;top:55px;border-radius:50px;text-align:center;line-height:74px;color:#fff;margin:1px;float:left;background-color:rgba(0,171,227,1);}';
