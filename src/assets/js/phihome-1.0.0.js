...
;(function () {
  ...
  var app = {
    ...
    openRouterPage: function (routerName, successCallback) {
      var data = JSON.stringify({routerName: routerName});
      JSBridge.callHandler('openRouterPage', data, function (response) {
        successCallback(response);
      });
    }
  };
  ...
  var util = {
    ...
    onStatisEvent: function (params, successCallback) { // 友盟埋点统计
      var data = JSON.stringify({
        eventType: params.eventName,
        eventId: params.eventID,
        pageTitle: params.pageTitle
      });
      JSBridge.callHandler('onStatisEvent', data, function (response) {
        successCallback(response);
      });
    }
  };
