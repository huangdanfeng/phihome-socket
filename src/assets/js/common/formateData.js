 ...
 * 检测设备是否解绑
 */
function checkDeviceBindStatus (_this) {
...
export {handlePushDataReceiveData, extendDeeply, copyDeeply, initData, HOURSTIMES, MINUTESTIMES, timeList, getDateValue, checkDeviceBindStatus};
